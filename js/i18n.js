const translations = {
    ...
    'en': {
        ...
        'skill-f10-name': 'Healing Phoenix',
        'skill-f10-desc': 'Restores part of health',
        'skill-w1-name': 'Water Jet',
        'skill-w1-desc': 'Basic water attack',
        'skill-w5-name': 'Bubble Shield',
        'skill-w5-desc': 'Creates a temporary protection',
        'skill-w10-name': 'Coordinated Tsunami',
        'skill-w10-desc': 'Massive area attack',
        'skill-e1-name': 'Rock Smash',
        'skill-e1-desc': 'Basic earth attack',
        'skill-e5-name': 'Iron Skin',
        'skill-e5-desc': 'Increases defense for 2 turns',
        'skill-e10-name': 'Stunning Earthquake',
        'skill-e10-desc': 'Chance to stun the target',
        'skill-a1-name': 'Wind Slash',
        'skill-a1-desc': 'Basic air attack',
        'skill-a5-name': 'Fast Flight',
        'skill-a5-desc': 'Chance to dodge attacks',
        'skill-a10-name': 'Triple Hurricane',
        'skill-a10-desc': 'Three fast consecutive attacks',
        'gen-lvl-prefix': 'Lvl',
